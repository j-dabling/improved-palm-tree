...
random_list_test_() ->
	Random_numbers = [rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10),rand:uniform(10)],%replace this with the list of 10 random integers 
...
person_tuple_list_test_() ->
	People = [{zane,male,6.0},{colton,male,5.9},{cameron,male,6.3},{mckay,male,5.9},{camden,male,5.10},{jesse,male,6.3},{zoie,female,5.4},{teage,male,6.1}],%replace this with the list of tuples described in the previous comment
